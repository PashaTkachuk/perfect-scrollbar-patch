...
## Why perfect-scrollbar-patch?

perfect-scrollbar-patch is a patch version of perfect-scrollbar package (which seems is not maintained anymore). perfect-scrollbar is minimalistic but *perfect* (for us, and maybe for most
